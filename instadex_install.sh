...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='instadex.conf'
CONFIGFOLDER='/root/.instadex'
COIN_DAEMON='instadexd'
COIN_CLI='instadex-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/g00tch/InstaDEX/releases/download/V1.0.0.2/InstaDEX.zip'
...
function important_information() {
 echo
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${GREEN}Windows Wallet Guide: ${PURPLE}https://github.com/g00tch/InstaDEX/blob/master/README.md${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 ...
 echo -e "${GREEN}instadex-cli getinfo. ${CYAN} Compare the Blocks line with the explorer to ensure the VPS is synced${NC}"
 echo -e "${GREEN}instadex-cli masternode status${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${RED}Donations are not expected, but I did just save you a bunch of time :D${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${YELLOW}$COIN_NAME Wallet: iAXJhWRiF5zh2jmszWA6SmbBRFoCRLkqjf${NC}"
